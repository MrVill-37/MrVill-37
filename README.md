...
Terminal-based and offline-capable wallet operations helper focused on **defensive** and **consent-based** workflows.
...
- Builds a **non-broadcast sweep plan** for ETH/ERC-20/NFT assets across:
  ...
  - zkSync
  - BNB Chain
- Provides a futuristic web UI (`/ui/index.html`) for operators who want a visual workflow.
